...
export declare const getDefaultErrorCode: (fieldType: any) => string;
/**
 * If error translation exists then error (code) is usable, else return a default error code
 * @param error -
 * @param i18n -
 */
export declare const getVerifiedErrorCode: (fieldType: string, error: string, i18n: Language) => string;
